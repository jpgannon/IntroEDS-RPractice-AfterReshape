...
1. Using the data from McD_Ex_Data.csv, create a plot of stream stage (the level in the stream) over time. Show the data as a line, label axes, and do not use the default ggplot theme.
...
Describe what you see. Are the two temperatures related? Are there conditions where they are less related?
...
So basically you want a line plot of temperature through time, where one line shows the temperature in the stream pool and the other shows temperature in the flowing streamwater.
